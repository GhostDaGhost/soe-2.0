...
function Process(action, finish)
    ActionStart()
    mythic_action = action
    if not exports["soe-emergency"]:IsDead() or mythic_action.useWhileDead then
        if not isDoingAction then
            ...
            SendNUIMessage({action = "startProgressBar", duration = mythic_action.duration, label = mythic_action.label})
            CreateThread(
                function()
                    while isDoingAction do
                        ...
                        if exports["soe-emergency"]:IsDead() and not mythic_action.useWhileDead then
                            Cancel()
                        end
                    end
                    if (finish ~= nil) then
        ...
        exports["soe-ui"]:SendAlert("error", "Cannot Perform An Action While Dead", 1000)
    end
end
            ...
            while runProgThread do
                if isDoingAction then
                        ...
                        if mythic_action.animation ~= nil then
                            ...
                            elseif mythic_action.animation.animDict ~= nil and mythic_action.animation.anim ~= nil then
                                ...
                                if (DoesEntityExist(player) and not IsEntityDead(player)) then
                                    LoadAnimDict(mythic_action.animation.animDict, 5)
                                    TaskPlayAnim(
                                        player,
                                        mythic_action.animation.animDict,
                                        mythic_action.animation.anim,
                                        3.0,
                                        1.0,
                                        -1,
                                        mythic_action.animation.flags,
                                        0,
                                        0,
                                        0,
                                        0
                    ...
                    if not isProp and mythic_action.prop ~= nil and mythic_action.prop.model ~= nil then
                        LoadModel(GetHashKey(mythic_action.prop.model), 0)

                        local pCoords = GetOffsetFromEntityInWorldCoords(PlayerPedId(), 0.0, 0.0, 0.0)
                        local modelSpawn =
                            CreateObject(
                            GetHashKey(mythic_action.prop.model),
                            pCoords.x,
                            pCoords.y,
                            pCoords.z,
                            true,
                        ...
                        AttachEntityToEntity(
                            modelSpawn,
                            PlayerPedId(),
                            GetPedBoneIndex(PlayerPedId(), mythic_action.prop.bone),
                            mythic_action.prop.coords.x,
                            mythic_action.prop.coords.y,
                            mythic_action.prop.coords.z,
                            mythic_action.prop.rotation.x,
                            mythic_action.prop.rotation.y,
                            mythic_action.prop.rotation.z,
                            1,
                            1,
                            0,
                            1,
                        ...
                        if not isPropTwo and mythic_action.propTwo ~= nil and mythic_action.propTwo.model ~= nil then
                            LoadModel(GetHashKey(mythic_action.propTwo.model), 0)

                            local pCoords = GetOffsetFromEntityInWorldCoords(PlayerPedId(), 0.0, 0.0, 0.0)
                            local modelSpawn =
                                CreateObject(
                                GetHashKey(mythic_action.propTwo.model),
                                pCoords.x,
                                pCoords.y,
                                pCoords.z,
                                true,
                            ...
                            AttachEntityToEntity(
                                modelSpawn,
                                PlayerPedId(),
                                GetPedBoneIndex(PlayerPedId(), mythic_action.propTwo.bone),
                                mythic_action.propTwo.coords.x,
                                mythic_action.propTwo.coords.y,
                                mythic_action.propTwo.coords.z,
                                mythic_action.propTwo.rotation.x,
                                mythic_action.propTwo.rotation.y,
                                mythic_action.propTwo.rotation.z,
                                1,
                                1,
                                0,
                                1,
...
RegisterNUICallback("actionFinish", Finish)
