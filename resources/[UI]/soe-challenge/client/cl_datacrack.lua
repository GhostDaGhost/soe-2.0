...
--    Local Functions
-- **********************
local function F_02542(arg1)
    return (arg1 * 57.29578)
end

-- WHEN TRIGGERED, ABORT MINIGAME
local function Abort()
    stophack = true
    TriggerEvent("Challenge:Client:DatacrackCB", false)
end

local function F_02541(arg1, arg2, arg3)
    local number number = ((1.0 - Cos(F_02542((arg3 * 3.141593)))) * 0.5)
    return ((arg1 * (1 - number)) + (arg2 * number))
end

local function F_02540(arg1)
...
function F_02668(arg1)
    ...
    while true do
        ...
        if Dat_2[1].val4 == false and Dat_2[2].val4 == false and Dat_2[3].val4 == false and Dat_2[4].val4 == false and Dat_2[5].val4 == false and Dat_2[6].val4 == false and Dat_2[7].val4 == false then
            ...
            Wait(2500)
            stophack = true
            TriggerEvent("Challenge:Client:DatacrackCB", true)
            return
        end
        Wait(1)
    end
